...
def get_compound_info(compound):
    ...
    try:
        ...
        if mol is None:
            ...
            identifiers_list[0] = ''.join(('smiles:', new_smiles))
    except IndexError:
        pass
    ...
    # print(chemical_dict['identifiers'])
                    ...
                    if f.endswith('.xml'):
                        ...
                        for reaction in root:
                            ...
                            for reactionAction in reactionActions:
                                ...
                                for text in texts:
                                    stages_list.append('{0}{1}'.format('step {}:'.format(counter), text.text))
