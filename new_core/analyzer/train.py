...
class Train():
    def __init__(self, data_loader, regressors):
        # Estimator.__init__(self, algorithm, dataset, target, feat_meth, tune, cv_folds, opt_iter)
        self.test_molecules = data_loader.test_molecules
        self.test_target = data_loader.test_target
        self.train_features = data_loader.train_features
        self.train_target = data_loader.train_target
        self.test_features = data_loader.test_features
        self.algorithm = regressors.algorithm
        self.regressor = regressors.regressor
        self.fit_params = regressors.fit_params
